...
#include "tut_interfaces/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tut_interfaces::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tut_interfaces::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tut_interfaces::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tut_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tut_interfaces::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &tut_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tut_interfaces, msg, Sphere)() {
  return &tut_interfaces::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
